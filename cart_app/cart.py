...
class Cart(object):
    def __init__(self, request):
        ...
        self.cart = self.session.get(settings.CART_SESSION_ID)  # if cart exists return, otherwise None
        if not self.cart:  # if cart is not already initialized, initialize it with empty dicts
